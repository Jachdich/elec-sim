...
public class NotGate extends Component {
	public NotGate(Vector pos, long uuid) {
		super(pos, uuid);
		this.connections = new Connection[2];
		float x = HelperFunctions.snap(this.pos.x);
		float y = HelperFunctions.snap(this.pos.y);
		this.connections[0] = new Connection(new Vector(x + 14, y - 10), new Vector(uuid, 0));
		this.connections[1] = new Connection(new Vector(x + 14, y + 34), new Vector(uuid, 1));
	}
	...
	public Component copy() {
		Component c = new NotGate(this.pos.copy(), this.getUUID());
